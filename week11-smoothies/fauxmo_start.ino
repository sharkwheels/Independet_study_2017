/*
https://learn.adafruit.com/easy-alexa-or-echo-control-of-your-esp8266-huzzah/neopixel-plus-relay-demo
https://www.arduino.cc/en/Reference/Volatile
https://bitbucket.org/xoseperez/fauxmoesp
https://www.reddit.com/r/amazonecho/comments/4gaf05/discovery_a_lot_more_smart_home_action_phrases/
https://iot.stackexchange.com/questions/323/how-to-write-custom-alexa-skills-without-ask-xxxx

uses built in firmware for alexa. Handy. 
*/
...
#define WIFI_SSID "Middle Earth"
#define WIFI_PASS "ptyalin7[neurologist"
...
void setup() {
    ...
    Strip1.begin();
    Strip1.Fade(Strip1.Color(0,0,0), Strip1.Color(0,0,0),200,20);
...
void loop() {
  ...
  if (neopixel_state) {
    ...
    Strip1.Color1 = Strip1.Color(29, 175, 166); 
    Strip1.Interval = 5;
